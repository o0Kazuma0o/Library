 ...
 * @author PC
 */
public class BGLogin extends JComponent{
    ...
    public BGLogin(){
        image = new ImageIcon(getClass().getResource("/Icons/Login.jpg"));
    }
    ...
    private void createBlurImage(Graphics2D g){
        ...
        if(width > 0 && height > 0){
            ...
            Shape shape = new FancyBorderRadius(width, height, "34% 66% 34% 66% / 66% 34% 66% 34%").getShape();
            g2.fill(shape);
